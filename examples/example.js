...
const seedPhrase = mnemonicToEntropy('grocery crush fantasy pulse struggle brain federal equip remember figure lyrics afraid tape ugly gold yard way isolate drill lawn daughter either supply student');
...
sdk.initiate(onFinished).then(session => {
    ...
    async function onConnected() {
        return session.phrase(seedPhrase, Language.English, // seed phrase language; optional, defaults to english
        "my phrase");
    }
